...
public class Task {
    ...
    public Task(String name, String description, Priority priority,
                LocalDate startDate, LocalDate dueDate, Engineer assignee,
    ...
    public String toString() {
        return String.format("name: %s, description: %s, priority: %s, startdate: %s, " +
                "duodate: %s, engineer: %s, label: %s, status: %s", name, description, priority, startDate.toString(),
                dueDate.toString(), assignee, label, status);
    }
}
